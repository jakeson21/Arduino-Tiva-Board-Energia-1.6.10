...
void CheckForBootloaderRequest(tLineCoding *psLineCoding)
{
    ...
    {
        USBBufferWrite((tUSBBuffer *)&g_sTxBuffer, (const uint8_t *)"Bootloader time\n", 16);
...
void _init(void)
{
    ...
    //
    InitUSBVCOM(CheckForBootloaderRequest);
    USBBufferWrite((tUSBBuffer *)&g_sTxBuffer, (const uint8_t *)"Ready\n", 6);
